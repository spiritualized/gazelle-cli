...
class Desktop:
	...
	def _handle_download_dir( self, download_dir ):
		out = None
		if download_dir:
			if "dir_active_download" not in self.settings_get( ):
				raise utorrent.uTorrentError( "A default directory MUST be set and enabled in uTorrent to use this option.")
